...
#define opt_hpa_sec_max_alloc JEMALLOC_N(opt_hpa_sec_max_alloc)
#define opt_hpa_sec_max_bytes JEMALLOC_N(opt_hpa_sec_max_bytes)
#define opt_hpa_sec_nshards JEMALLOC_N(opt_hpa_sec_nshards)
#define opt_hpa_slab_max_alloc JEMALLOC_N(opt_hpa_slab_max_alloc)
...
#define arena_handle_new_dirty_pages JEMALLOC_N(arena_handle_new_dirty_pages)
...
#define edata_cache_small_disable JEMALLOC_N(edata_cache_small_disable)
#define edata_cache_small_get JEMALLOC_N(edata_cache_small_get)
#define edata_cache_small_init JEMALLOC_N(edata_cache_small_init)
#define edata_cache_small_put JEMALLOC_N(edata_cache_small_put)
...
#define emap_lock_edata JEMALLOC_N(emap_lock_edata)
#define emap_lock_edata2 JEMALLOC_N(emap_lock_edata2)
#define emap_lock_edata_from_addr JEMALLOC_N(emap_lock_edata_from_addr)
...
#define emap_unlock_edata JEMALLOC_N(emap_unlock_edata)
#define emap_unlock_edata2 JEMALLOC_N(emap_unlock_edata2)
#define eset_bitmap_info JEMALLOC_N(eset_bitmap_info)
...
#define hpa_central_alloc_grow JEMALLOC_N(hpa_central_alloc_grow)
#define hpa_central_alloc_reuse JEMALLOC_N(hpa_central_alloc_reuse)
#define hpa_central_dalloc JEMALLOC_N(hpa_central_dalloc)
...
#define prof_dump_prefix_set JEMALLOC_N(prof_dump_prefix_set)
...
#define psset_fit JEMALLOC_N(psset_fit)
